...
Game::Game(int window_width, int window_height, SDL_Window* window)
{
	...
	mesh2 = Mesh::Get("data/back_part.obj"); //objeto pequeño 
	mesh = Mesh::Get("data/back_part.obj"); // objecto pequeño
...
void Game::render(void)
{
	...
	m2.scale(20, 20, 20); //cambiar tamaño bola
	...
	Matrix44 m;
	m.scale(20, 20, 20); //cambiar tamaño
